...
const FROM = process.env.EMAIL_FROM || 'OnboardFlow - Interactive Remote Training Modules <noreply@example.com>';
const APP_NAME = 'OnboardFlow - Interactive Remote Training Modules';
