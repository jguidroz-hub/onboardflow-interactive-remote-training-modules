  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">OnboardFlow - Interactive Remote Training Modules</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Helps HR teams and managers quickly create engaging, interactive training modules and quizzes for remote employee onboarding, ensuring consistent learning and compliance without extensive development.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust OnboardFlow - Interactive Remote Training Modules.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} OnboardFlow - Interactive Remote Training Modules. All rights reserved.</p>
